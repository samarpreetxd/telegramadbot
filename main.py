# Credits : https://t.me/neverendinginsanity
# Contact : https://t.me/natxsupport_bot
# Portal : https://t.me/monkeyportal69
...
class Telegram():
    ...
    def save_group_ids(self, groups):
        with open("group_ids.txt", "w", encoding="utf-8") as file:
            for group in groups:
                file.write(f"{group.id}: {group.title}\n")
